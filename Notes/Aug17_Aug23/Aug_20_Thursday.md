# Goals for Today
* Figure out why model is 100% accurate.
* Get ghosts engineers profile finished.
* Meeting for debugging model



# Notes
* Add to my calander when I'll be working on the BADGER project for Josh.
